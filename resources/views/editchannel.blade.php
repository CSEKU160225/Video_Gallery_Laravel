...
<form action="{{route('editchannelstore',$Chan->id)}}" method="post">
  {{csrf_field()}}
  
  <div class="form-group">
    <label for="exampleFormControlInput1">Edit Channel</label>
    <input type="text" class="form-control" value="{{$Chan->channel_name}}" name="channel">
  </div>

  <div class="form-group">
    <label for="exampleFormControlTextarea1">Comments</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" value="{{$Chan->comments}}" rows="10" cols="4" name="comment"></textarea>
    
  </div>
    <div class="form-group">
    <label for="exampleFormControlInput1">Add Channel Link</label>
    <input type="text" class="form-control" value="{{$Chan->link}}" name="link">
  </div>
