...
<form action="{{route('channel')}}" method="post">
  {{csrf_field()}}
  <div class="form-group">
    <label for="exampleFormControlInput1">Add Channel</label>
    <input type="text" class="form-control" name="channel">
  </div>

  <div class="form-group">
    <label for="exampleFormControlTextarea1">Comments</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" cols="4" name="comment"></textarea>
  </div>
    <div class="form-group">
