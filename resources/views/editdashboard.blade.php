...
<form action="{{route('dashboardstore',$vid->id)}}" method="post">
  {{csrf_field()}}
  
  <div class="form-group">
    <label for="exampleFormControlInput1">Edit Category</label>
    <input type="text" class="form-control" value="{{$vid->category}}" name="category">
  </div>

  <div class="form-group">
    <label for="exampleFormControlTextarea1">Comments</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" value="" rows="10" cols="4" name="comments"></textarea>
